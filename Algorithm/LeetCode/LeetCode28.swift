...
//        print(strStr("abbbbayya", "xzz"))
        
        print(strStr2("abbbbayya", "yy"))
    ...
    func strStr2(_ haystack: String, _ needle: String) -> Int {
        ...
        for i in 0 ... (hlength - nlength) {
            ...
            let haystackA = haystack.index(haystack.startIndex, offsetBy: i)
            
            let haystackB = haystack.index(haystack.startIndex, offsetBy: i + nlength)
            
            print(haystack[haystackA..<haystackB])
            
            if (haystack[haystackA..<haystackB] == needle) {
                return i
            }
